<template>
  <ArticleLayout>
    <main class="mx-auto mt-16 lg:mt-32 container-inner">
      <h1 class="text-2xl font-bold lg:text-3xl">{{ $page.article.title }}</h1>
      <p class="mt-2 text-sm lg:mt-4 lg:text-base text-blue40">Last update on <time :datetime="$page.article.datetime">{{ $page.article.date }}</time></p>
      <ul class="mt-2">

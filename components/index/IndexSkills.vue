<template>
  <div class="mt-10 lg:mt-20">
    ...
    <div class="py-20 lg:py-40 bg-primary text-white">
      <div class="container">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-x-20">
          ...
          <div class="mt-10 lg:mt-0 grid grid-cols-5 lg:grid-cols-3 gap-y-10">
            ...
            <a class="transform hover:scale-110 transition-transform duration-100 ease-in-out" href="https://developer.mozilla.org/en-US/docs/Learn/JavaScript/First_steps/What_is_JavaScript" target="_blanck">
              <img class="w-18 h-18 mx-auto" src="~/assets/logos/javascript.svg" />
            </a>
